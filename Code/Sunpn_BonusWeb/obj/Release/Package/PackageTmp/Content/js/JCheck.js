    ...
    $.fn.jRadio = function (settings) {
        ...
        radios.each(function ()
        {
            ...
            if($radio.find('input[type="radio"]').is(':checked')) {
                ...
                //$otherRadios.find('span').removeClass("selera");
                //$("span").removeClass();
                //$otherRadios.find("span").addClass("selera");
            ...
            $radio.on("change", function () {
                if (!$(this).hasClass(options.checkedClass)) {
                    ...
                    //radios.filter("[data-name='" + _name + "']").not($(this)).removeClass("selera");
                    //$(this).find("span").addClass("selera");
                    //alert($(this).find("span").html());
                }
            });
        });
